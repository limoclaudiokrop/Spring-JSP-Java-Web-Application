...
<!--Main Navigation-->
          ...
          <main style="padding-top: 100px;  height: 100vh;">
          	<div class="container mb-5">
          		<form method="post" action='http://localhost:8080/new_item'>
	          		<div class="d-flex justify-content-center align-items-center">
	          		...
	          		<div class="d-flex justify-content-center align-items-center mt-3">
	          			<h5>Enter Food Category e.g Vegeterian</h5>
	          		</div>
	          		<div class="d-flex justify-content-center align-items-center">
	          			<input class="form-control" name="category" style="width: 50%">
	          		</div>
	          		<div class="d-flex justify-content-center align-items-center mt-3">
	          			<h5>Enter Number of servings</h5>
	          		</div>
	          		<div class="d-flex justify-content-center align-items-center">
	          			<input class="form-control" name="count" style="width: 50%">
	          		</div>
	          		<div class="d-flex justify-content-center align-items-center mt-3">
	          			<h5>Enter Image link</h5>
	          		</div>
	          		<div class="d-flex justify-content-center align-items-center">
	          			<input class="form-control" name="link" style="width: 50%">
	          		</div>
	          		<div class="d-flex justify-content-center align-items-center mt-3">
	          			<h5>Enter Description</h5>
	          		</div>
	          		<div class="d-flex justify-content-center align-items-center">
	          			<textarea class="form-control" name="desc" rows="4" style="width: 50%"></textarea>
	          		</div>
	          		<div class="d-flex justify-content-center align-items-center mt-3">
	          			<h5>Ingredients</h5>
	          		</div>
	          		<div class="d-flex justify-content-center align-items-center">
	          			<textarea class="form-control" name="ingredients" rows="4" style="width: 50%"></textarea>
	          		</div>
	          		<div class="d-flex justify-content-center align-items-center mt-3">
	          			<h5>Instructions</h5>
	          		</div>
	          		<div class="d-flex justify-content-center align-items-center">
	          			<textarea class="form-control" name="instruction" rows="4" style="width: 50%"></textarea>
	          		</div>
